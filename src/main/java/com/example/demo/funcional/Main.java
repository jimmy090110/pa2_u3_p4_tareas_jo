...
//				LOG.info("SUPPLIER METODO REFERENCIADO: " + supplier4.getId());	
        ...
        // Llamada al método aplicar
        
        LOG.info("Function referida: " + function2.aplicar(3));
		...
		IPersonaUnaryOperator<Integer>unary3 = metodos::agregar;
		LOG.info("Unary Referido: "+unary3.aplicar(3));
